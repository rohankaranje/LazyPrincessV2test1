...
BOT_TOKEN = environ.get('BOT_TOKEN', "6764535034:AAHxA4PHkvj5MyL_NVZU2hvb91714F-7hT8")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002074833946')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Filterbot:jo3Ko2no03dSionR@cluster0.shuqus4.mongodb.net/?retryWrites=true&w=majority")
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'api.shareus.in/directLink')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'n5MhJBExtOU1Wl0S3YTQuVnKIVe2')
